...
<header className="fixed top-0 left-0 right-0 h-16 z-40 bg-white/90 dark:bg-slate-900/90 border-b border-slate-200/80 dark:border-slate-800/80 text-slate-800 dark:text-slate-100 backdrop-blur-md px-3 md:px-6 flex items-center justify-between shadow-xs">               
...
<div className="w-full flex items-center gap-2.5 px-3.5 py-1.5 rounded-xl border transition-all duration-200 bg-slate-100/70 dark:bg-slate-800/50 border-slate-200/80 dark:border-slate-700/60 hover:border-slate-300 focus-within:bg-white dark:focus-within:bg-slate-800 focus-within:border-blue-500 focus-within:ring-2 focus-within:ring-blue-500/20 focus-within:shadow-md">
...
className="w-full bg-transparent text-sm outline-none text-slate-800 dark:text-slate-100 placeholder:text-slate-400"/>
<kbd className="hidden sm:inline-flex items-center justify-center min-w-[58px] whitespace-nowrap shrink-0 px-2 py-0.5 rounded-md text-[10px] font-mono font-medium tracking-wide bg-slate-200/80 dark:bg-slate-700/80 text-slate-500 dark:text-slate-300 border border-slate-300/60 dark:border-slate-600">              Ctrl + K
            </kbd>
          </div>
        </div>
...
className="cursor-pointer w-full flex items-center gap-2 px-3 py-2 rounded-xl text-sm hover:bg-slate-100 dark:hover:bg-slate-700/60">
     <Keyboard size={16} /> Shortcuts
                  ...
                  <button type="button" className="cursor-pointer w-full flex items-center gap-2 px-3 py-2 rounded-xl text-sm text-red-500 hover:bg-red-50 dark:hover:bg-red-950/30"
