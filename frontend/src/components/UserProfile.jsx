...
<div className="w-24 h-24 sm:w-28 sm:h-28 rounded-full text-white bg-linear-to-br from-purple-600 to-blue-500 hover:bg-linear-to-bl focus:ring-4 focus:outline-none border-4 border-white focus:ring-blue-300 font-medium shadow-md flex items-center justify-center font-bold text-3xl">                                {user.username ? user.username.charAt(0).toUpperCase() : <User className="w-12 h-12" />}
                            </div>
