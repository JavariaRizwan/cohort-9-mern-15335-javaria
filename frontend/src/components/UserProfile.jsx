...
            <div name='name' className="p-3 rounded-xl bg-slate-50 border border-slate-200 text-sm font-medium text-slate-800">
              {user.username}
            </div>
          </div>
...
            <div name='email' className="p-3 rounded-xl bg-slate-50 border border-slate-200 text-sm font-medium text-slate-800">
              {user.email}
            </div>
          </div>
        </div>
